...
class ItemViewModelTest {
     ...
     fun testSuccessCase() = runTest {
         ...
         val viewModel = ItemViewModel(ApiUseCase(repository))
...
private fun getSuccessMap(): Map<Int, List<Item>> {
    return mapOf(1 to listOf(Item(listId = 1, name = "okay 1", id = 1), Item(listId = 1, name = "okay 1", id = 2), Item(listId = 1, name = "okay 1", id = 3)), 2 to listOf(Item(listId = 2, name = "okay 1", id = 1), Item(listId = 2, name = "okay 2", id = 2)))
}

private fun getItems() : List<Item> {
    return listOf(Item(listId = 1, name = "okay 1", id = 1), Item(listId = 2, name = "okay 1", id = 1), Item(listId = 1, name = "okay 1", id = 2), Item(listId = 1, name = "okay 1", id = 3), Item(listId = 2, name = "okay 2", id = 2))
}